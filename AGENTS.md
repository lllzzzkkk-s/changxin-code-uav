...
- From the 4060/HMI side, operate the vehicle-side gateway over SSH without hosting the executor on 4060: `bash ugv/01-scripts/operate_unit_ugv_vehicle_gateway_ssh.sh --remote yhs@192.168.0.201 status`

...
MIGRATION_FILE_PATTERNS = (
    ...
    "tools/check_unit_ugv_object_target_readiness.py",
    ...
    *,
    ...
    return {
        ...
        "commands": {
            ...
            "check_unit_ugv_object_target_readiness": "PYTHONDONTWRITEBYTECODE=1 python3 tools/check_unit_ugv_object_target_readiness.py --target-map <unit_ugv_targets.json> --object-query <object-name> --platform-id ugv_0 --write-missing-template",
            "seed_unit_ugv_target_map_from_yolo_detection": "PYTHONDONTWRITEBYTECODE=1 python3 tools/seed_unit_ugv_target_map_from_yolo_detection.py --detections <ObjectDetectionSet.v1.json> --target-map <unit_ugv_targets.json> --object-query <object-name> --platform-id ugv_0 --output /tmp/changxin-unit-ugv-yolo-target-seed.json",
            "check_unit_ugv_target_map": "PYTHONDONTWRITEBYTECODE=1 python3 tools/check_unit_ugv_target_map.py --target-map <unit_ugv_targets.json> --platform-id ugv_0 --require-object-queries --select-object-query <object-name> --output /tmp/changxin-unit-ugv-target-map-check.json",
            "check_unit_ugv_artifact_target_map": "PYTHONDONTWRITEBYTECODE=1 python3 tools/check_unit_ugv_artifact_target_map.py <artifact_bundle_path> --target-map <unit_ugv_targets.json> --platform-id ugv_0 --index 0",
            "prepare_unit_ugv_object_approach_bundle": "PYTHONDONTWRITEBYTECODE=1 python3 tools/prepare_unit_ugv_object_approach_bundle.py <artifact_bundle_path> --target-map <unit_ugv_targets.json> --output-dir /tmp/changxin-unit-ugv-object-approach-prep --platform-id ugv_0 --index 0",
            ...
            "plan_unit_ugv_gateway_dry_run": "PYTHONDONTWRITEBYTECODE=1 python3 tools/plan_unit_ugv_gateway_call.py --prep-report /tmp/changxin-unit-ugv-object-approach-prep/prep_bundle_report.json --profile <local-work-hardware-ros1-gateway.env> --mode dry_run",
            "run_unit_ugv_gateway_dry_run": "PYTHONDONTWRITEBYTECODE=1 python3 tools/run_unit_ugv_ros_gateway_dry_run.py --handoff-report /tmp/changxin-unit-ugv-object-approach-handoff/ros_ready_handoff_report.json --output-dir /tmp/changxin-unit-ugv-gateway-dry-run",
            "parse_unit_ugv_gateway_dry_run_response": "PYTHONDONTWRITEBYTECODE=1 python3 tools/parse_unit_ugv_ros_gateway_dry_run_response.py --response-stdout /tmp/changxin-unit-ugv-gateway-dry-run/dry_run_response.txt --output-dir /tmp/changxin-unit-ugv-gateway-dry-run-parsed --expected-platform-id ugv_0",
...
def _migration_doc(rel_files: Sequence[str]) -> str:
    return "\n".join([
        ...
        "# Optional future YOLO seed path; still requires local operator target-map confirmation before ROS handoff:",
        "PYTHONDONTWRITEBYTECODE=1 python3 tools/seed_unit_ugv_target_map_from_yolo_detection.py --detections <ObjectDetectionSet.v1.json> --target-map <unit_ugv_targets.json> --object-query <object-name> --platform-id ugv_0 --output /tmp/changxin-unit-ugv-yolo-target-seed.json",
        "PYTHONDONTWRITEBYTECODE=1 python3 tools/check_unit_ugv_target_map.py --target-map <unit_ugv_targets.json> --platform-id ugv_0 --require-object-queries --select-object-query <object-name> --output /tmp/changxin-unit-ugv-target-map-check.json",
        "PYTHONDONTWRITEBYTECODE=1 python3 tools/check_unit_ugv_artifact_target_map.py <artifact_bundle_path> --target-map <unit_ugv_targets.json> --platform-id ugv_0 --index 0",
        "PYTHONDONTWRITEBYTECODE=1 python3 tools/prepare_unit_ugv_object_approach_bundle.py <artifact_bundle_path> --target-map <unit_ugv_targets.json> --output-dir /tmp/changxin-unit-ugv-object-approach-prep --platform-id ugv_0 --index 0",
        "PYTHONDONTWRITEBYTECODE=1 python3 tools/prepare_unit_ugv_object_approach_pipeline.py --profile profiles/dev_mock.env --intent '<operator-intent>' --mission-id <mission_id> --case-id <case_id> --target-map <unit_ugv_targets.json> --ros1-gateway-profile <local-work-hardware-ros1-gateway.env> --output-dir /tmp/changxin-unit-ugv-object-approach-handoff --platform-id ugv_0 --index 1",
        "PYTHONDONTWRITEBYTECODE=1 python3 tools/plan_unit_ugv_gateway_call.py --prep-report /tmp/changxin-unit-ugv-object-approach-prep/prep_bundle_report.json --profile <local-work-hardware-ros1-gateway.env> --mode dry_run",
        "PYTHONDONTWRITEBYTECODE=1 python3 tools/run_unit_ugv_ros_gateway_dry_run.py --handoff-report /tmp/changxin-unit-ugv-object-approach-handoff/ros_ready_handoff_report.json --output-dir /tmp/changxin-unit-ugv-gateway-dry-run",
        "# If rosservice returned response_json as YAML-wrapped text, parse the existing stdout without calling ROS again:",
        "PYTHONDONTWRITEBYTECODE=1 python3 tools/parse_unit_ugv_ros_gateway_dry_run_response.py --response-stdout /tmp/changxin-unit-ugv-gateway-dry-run/dry_run_response.txt --output-dir /tmp/changxin-unit-ugv-gateway-dry-run-parsed --expected-platform-id ugv_0",

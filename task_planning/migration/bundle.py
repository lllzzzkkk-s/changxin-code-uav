    ...
    *,
    ...
    return {
        ...
        "commands": {
            ...
            "check_unit_ugv_target_map": "PYTHONDONTWRITEBYTECODE=1 python3 tools/check_unit_ugv_target_map.py --target-map <unit_ugv_targets.json> --platform-id ugv_0 --require-object-queries --select-object-query <object-name>",
...
def _migration_doc(rel_files: Sequence[str]) -> str:
    return "\n".join([
        ...
        "PYTHONDONTWRITEBYTECODE=1 python3 tools/check_unit_ugv_target_map.py --target-map <unit_ugv_targets.json> --platform-id ugv_0 --require-object-queries --select-object-query <object-name>",
